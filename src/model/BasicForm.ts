...
export interface BasicForm extends Document {
...
const BasicFormSchema: Schema<BasicForm> = new Schema({
...
const BasicFormModel: Model<BasicForm> = mongoose.models.BasicForm as Model<BasicForm> || mongoose.model<BasicForm>("BasicForm", BasicFormSchema);
export default BasicFormModel;
